# Annotation
This md contains old impelementation code from README.

Use examples to get way of triggering and making model (until I make proper guide).

# Implementation (how to use) **[OLD]**
